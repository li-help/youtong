                              ...
                              child: ListView.builder(
                                ...
                                itemBuilder: (context, i) => GestureDetector(
                                  onTap: () => pushAppPage(context,
                                      page: ActivityDetailPage(id: (_activities[i]['id'] as num).toInt())),
                                  child: Container(
                                      ...
                                      children: [
                                        ClipRRect(
                                          ...
                                          child: SizedBox(
                                            ...
                                            child: AppNetworkImage(
                                              url: _activities[i]['cover']?.toString(),
                                              width: 100,
                                              height: 75,
                                              fit: BoxFit.cover,
                                            ),
                                        ...
                                        Expanded(
                                          child: Column(
                                            ...
                                            children: [
                                              Text(_activities[i]['title']?.toString() ?? '活动',
                                                  maxLines: 2, overflow: TextOverflow.ellipsis,
                                                  style: const TextStyle(fontWeight: FontWeight.bold)),
                                              const SizedBox(height: 6),
                                              Text(_activities[i]['summary']?.toString() ?? '',
                                                  maxLines: 2, overflow: TextOverflow.ellipsis,
                                                  style: const TextStyle(fontSize: 13, color: AppStyles.textSub)),
                                              Text('${_activities[i]['viewCount'] ?? 0}次浏览',
                                                  style: const TextStyle(fontSize: 12, color: AppStyles.primary)),
                                            ],
                                          ),
                                        ),
                                      ],
