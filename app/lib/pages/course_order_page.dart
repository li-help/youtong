    ...
    try {
      ...
      if (res['code'] == 0) {
        ...
        Future.delayed(const Duration(milliseconds: 800), () {
          if (mounted) Navigator.of(context).pushAndRemoveUntil(MaterialPageRoute(builder: (_) => const MainPage()), (_) => false);
        });
      } else {
                  ...
                  Padding(
                    ...
                    child: Row(
                      children: [
                        ...
                        const Expanded(child: Text('课程报名', textAlign: TextAlign.center, style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold))),
