...
class _MinePageState extends State<MinePage> {
  ...
  Future<void> _logout() async {
    ...
    Navigator.of(context).pushAndRemoveUntil(
        AppPageRoute(builder: (_) => const LoginPage()), (_) => false);
  }
                            ...
                            ClipOval(
                              child: Container(
                                ...
                                child: _user?['avatar'] != null &&
                                    ...
                                    ? AppNetworkImage(
                                        url: _user!['avatar'].toString(),
                                        fit: BoxFit.cover)
                                    : const FaIcon(FontAwesomeIcons.user,
                                        size: 36, color: AppStyles.textSub),
                              ),
                            ),
                        ...
                        child: const Row(
                          children: [
                            FaIcon(FontAwesomeIcons.baby,
                                color: AppStyles.primary, size: 32),
                            SizedBox(width: 12),
                            Expanded(
                                child: Text('完善宝宝档案',
                                    style: TextStyle(
                    ...
                    Container(
                      ...
                      child: Row(
                        children: [
                          ...
                          Container(
                              width: 1, height: 36, color: AppStyles.line),
                          _statItem(
                              '❤️',
                              _stats?['favoriteCount']?.toString() ?? '0',
                              '我的收藏',
                              _user == null
                                  ? () => Navigator.of(context).push(
                                      AppPageRoute(
                          ...
                          Container(
                              width: 1, height: 36, color: AppStyles.line),
                          _statItem('⭐', _stats?['growth']?.toString() ?? '0',
                              '成长值', null),
                        ],
                      ),
                    ),
        ...
        child: Row(
          children: [
            ...
            const FaIcon(FontAwesomeIcons.chevronRight,
                color: AppStyles.textLight, size: 16),
          ],
        ),
      ),
    );
      ...
      child: InkWell(
        ...
        child: Column(
          children: [
            ...
            Text(label,
                style:
                    const TextStyle(fontSize: 12, color: AppStyles.textLight)),
          ],
        ),
      ),
    );
